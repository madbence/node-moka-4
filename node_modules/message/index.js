module.exports=function(client){
	...
	client.reply=function(sender,target,msg,short){
		if(target.indexOf('#')>-1){
			return client.say(target,(short?'':(sender+': '))+msg);
		}
		client.say(sender,msg);
	}
	client.sreply=function(sender,target,msg){
		client.reply(sender,target,msg,true);
	}
